            ...
            <ion-col size="10" offset="1" class="ion-no-padding">
                <div class="svgContainer">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200.96 78.12">
                        ...
                        <g id="sunSvg" :style="this.showCurveSun ? {offsetDistance: getPercentDay + '%' } : {offsetDistance: '0%' }" v-show="this.showCurveSun && getPercentDay > 0">
                        ...
                        <g id="sunSvg" :style="this.showCurveSun ? {offsetDistance: (100 - (getPercentDay * -1)) + '%' } : {offsetDistance: '0%' }" v-show="this.showCurveSun && getPercentDay < 0">
        ...
        computed: {
            ...
            getTimeSunriseSunset () {
                ...
                if (dayTime < sunrise) {
                    ...
                    percentage = _.round( (((dayTime - (sunrise+86400)) / (sunset - (sunrise+86400))) * 100), 2)
                }
                return percentage
            }
        },
