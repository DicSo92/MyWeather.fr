            ...
            <ion-col size="10" offset="1" class="ion-no-padding">
                <div class="svgContainer">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200.96 78.12">
                        ...
                        <g id="sunSvg" :style="this.showCurveSun ? {offsetDistance: getPercentNight + '%' } : {offsetDistance: '0%' }" v-show="this.showCurveSun && getPercentNight > 0">
    ...
    export default {
        ...
        computed: {
            ...
            getTimeSunriseSunset () {
                if (this.getPercentDay > 0 && this.getPercentNight < 0) {
                    return {
                ...
                } else if (this.getPercentNight > 0 && this.getPercentDay < 0) {
                    return {
