            ...
            <ion-col size="10" offset="1" class="ion-no-padding">
                <div class="svgContainer">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200.96 78.12">
                        ...
                        <g id="sunSvg" :style="this.showCurveSun ? {offsetDistance: (getPercentDay * -1) + '%' } : {offsetDistance: '0%' }" v-show="this.showCurveSun && getPercentDay < 0">
    ...
    export default {
        ...
        computed: {
            ...
            getPercentDay () {
                ...
                if (percentage > 100) percentage = (percentage - 100) * -1
